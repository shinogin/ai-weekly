...
d    = {"subject": subj, "content": body, "description": subj, "public": False,
                "published_at": now, "preview_text": "今週のAIニュース", "send_at": now,
                "subscriber_filter": [{"all": []}]}
r    = requests.post("https://api.kit.com/v4/broadcasts", headers=h, json=d, timeout=30)
